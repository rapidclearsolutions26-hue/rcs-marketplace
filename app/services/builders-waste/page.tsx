...
export const metadata: Metadata = {
  title: "Builders Waste Removal Birmingham & West Midlands",
  description:
    "Builders waste removal across Birmingham and the West Midlands. Remove rubble, timber, plasterboard and renovation waste through the Rapid Clear Solutions Marketplace.",
  alternates: {
    canonical:
      "https://rapidclearsolutions.co.uk/services/builders-waste",
  },
  openGraph: {
    title: "Builders Waste Removal Birmingham & West Midlands",
    description:
      "Post your builders waste collection, upload photos and receive available quotes through the Rapid Clear Solutions Marketplace.",
    url: "https://rapidclearsolutions.co.uk/services/builders-waste",
...
const steps = [
  {
    ...
    description:
      "Add your collection details, postcode and information about the builders or renovation waste that needs clearing.",
  },
  {
    title: "Upload photos",
    description:
      "Photos help drivers understand the amount and type of waste involved and the requirements of the collection.",
  },
  {
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#050705] text-white">
      ...
      <section className="border-b border-white/[0.07]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-24">
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-gray-400 sm:text-lg">
            Need building or renovation waste cleared? Post your job through
            Rapid Clear Solutions, provide the collection details and upload
      ...
      <section className="bg-[#080b08]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-20">
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-gray-400">
            Builders waste can vary considerably depending on the project.
            Add as much information as possible when posting your job and
            upload photos to help drivers understand the collection.
          </p>
      ...
      <section className="border-t border-white/[0.07] bg-[#050705]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-20">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
            Arrange your builders waste collection
          </h2>
      ...
      <section className="border-t border-white/[0.07] bg-[#080b08]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-20">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
            Builders waste removal across the West Midlands
          </h2>
      ...
      <section className="border-t border-white/[0.07] bg-[#050705]">
        <div className="mx-auto max-w-4xl px-5 py-20 text-center sm:px-6 sm:py-28">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-gray-500">
            Post your builders waste collection in minutes and provide the
