...
export const metadata: Metadata = {
  title: "Rubbish Removal Birmingham & West Midlands",
  description:
    "Rubbish removal across Birmingham and the West Midlands. Post your job, upload photos and receive quotes through the Rapid Clear Solutions Marketplace.",
  alternates: {
    canonical:
      "https://rapidclearsolutions.co.uk/services/rubbish-removal",
  },
  openGraph: {
    title: "Rubbish Removal Birmingham & West Midlands",
    description:
      "Post your rubbish removal job, upload photos and receive quotes through the Rapid Clear Solutions Marketplace.",
    url: "https://rapidclearsolutions.co.uk/services/rubbish-removal",
...
const steps = [
  {
    ...
    description:
      "Add your collection details, postcode and information about the rubbish that needs removing.",
  },
  {
    title: "Upload photos",
    description:
      "Upload photos of the waste so drivers can understand the size and type of collection.",
  },
  {
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#050705] text-white">
      ...
      <section className="border-b border-white/[0.07]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-24">
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-gray-400 sm:text-lg">
            Need rubbish removed from your home, garden or property? Post
            your job through Rapid Clear Solutions, upload photos and provide
            your collection details. Your job can then be reviewed by
        ...
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-20">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
              A simple way to arrange your collection
            </h2>

            <p className="mt-5 text-base leading-8 text-gray-400">
              Whether you have household rubbish, unwanted items or general
              waste that needs clearing, you can post the job online and give
              drivers the information they need to understand the collection.
            </p>
          </div>
      ...
      <section className="border-t border-white/[0.07] bg-[#050705]">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-20">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">
            Rubbish removal across the West Midlands
          </h2>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {[
              ...
              <span
                key={area}
                className="rounded-full border border-white/[0.08] bg-[#080b08] px-4 py-2 text-sm font-bold text-gray-300"
              >
                {area}
              </span>
            ))}
      ...
      <section className="border-t border-white/[0.07] bg-[#080b08]">
        <div className="mx-auto max-w-4xl px-5 py-20 text-center sm:px-6 sm:py-28">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-gray-500">
            Post your rubbish removal job in minutes and provide the details
