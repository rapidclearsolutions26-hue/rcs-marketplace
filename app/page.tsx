...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#070907] pt-[env(safe-area-inset-top)] text-white">
      {/* ========================================================= */}
      {/* HEADER */}
      {/* ========================================================= */}
      ...
      <section className="border-b border-[#1d251b] bg-[#0a0d0a] py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div id="how-it-works" className="mt-12 grid gap-6 md:grid-cols-2">
            {/* CUSTOMER */}
            ...
            <div className="rounded-2xl border border-[#283326] bg-[#0d120d] p-8 transition hover:border-[#49673b]">
              ...
              <h3 className="mt-3 text-3xl font-black">Post your job.</h3>

              <p className="mt-4 leading-7 text-gray-400">
                Tell us what needs removing, upload photos and provide your
                collection details. Approved drivers can then view the job and
                submit their bids.
              </p>
            ...
            <div className="rounded-2xl border border-[#283326] bg-[#0d120d] p-8 transition hover:border-[#49673b]">
              ...
              <p className="mt-4 leading-7 text-gray-400">
                ...
                view available jobs and submit bids for work that suits your
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 leading-7 text-gray-500">
              We've designed the marketplace around a straightforward process
              so you know what happens at every stage.
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-3xl border border-[#283326] bg-[#0d120d] p-7 md:p-9">
              <div className="flex items-center gap-4 border-b border-[#253124] pb-6">
                ...
                <div>
                  <h3 className="font-black">Secure online payment</h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="rounded-3xl border border-[#283326] bg-[#0b100b] p-7 md:p-9">
                ...
                <div className="mt-7 border-t border-[#253124] pt-6">
                  <p className="text-sm leading-6 text-gray-500">
                    Drivers must complete the RCS application process and be
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-5 max-w-xl leading-8 text-gray-400">
                Anyone can't simply sign up and start taking marketplace jobs.
                Drivers apply through RCS and provide information about
                themselves, their business, vehicle and relevant documents
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-xl leading-8 text-gray-400">
                ...
                gives customers a straightforward marketplace for finding
                available drivers while giving independent waste businesses
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-2xl leading-8 text-gray-400">
                  ...
                  understand, easier to arrange and easier to manage from start
                  to finish.
                </p>
              </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-[#405c2d] bg-[#0d130c] p-8 md:p-12">
            ...
            <div className="relative flex flex-col justify-between gap-8 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black uppercase md:text-5xl">
                  WE WANT
                  <span className="text-[#79c51c]"> YOUR WASTE.</span>
                </h2>
      ...
      <footer className="border-t border-[#1d251b] bg-[#030403]">
        <div className="mx-auto max-w-7xl px-6 pb-[calc(3rem+env(safe-area-inset-bottom))] pt-12">
